...
class CollectionItemTest {
    CollectionItem contact;

    @BeforeEach
    void setUp() {
        contact = new CollectionItem("Example Document","Book","John Doe","Example Description","USA",
    ...
    public void testGetCollectionID() {
        assertEquals(1, contact.getCollectionid());
    }
    @Test
    public void testSetCollectionID() {
        contact.setCollectionid(2);
        assertEquals(2, contact.getCollectionid());
    }
